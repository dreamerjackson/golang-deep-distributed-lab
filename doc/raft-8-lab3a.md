...
git checkout --hard   d345b34bc
```

## client
* kvraft/client.go文件用于书写我们的客户端代码
...
* 本系列构建的kv-raft服务，根据不同的服务其应用操作的方式不同
* 下面的操作是简单的操作内存map数据库, 同时，将最后一个操作记录下来
```
